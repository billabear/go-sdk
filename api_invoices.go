...
/*
InvoicesApiService Charge Invoice
...
/*
InvoicesApiService Download Invoice
Returns the pdf blob for the invoice
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param invoiceId The id of the invoice
@return *os.File
*/
func (a *InvoicesApiService) DownloadInvoice(ctx context.Context, invoiceId string) (*os.File, *http.Response, error) {
	var (
...
/*
InvoicesApiService List Customer Invoices

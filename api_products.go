...
List all products
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ProductsApiListProductOpts - Optional Parameters:
...
/*
ProductsApiService Detail
Info for a specific product
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param productId The id of the product to retrieve
@return Product
*/
func (a *ProductsApiService) ShowProductById(ctx context.Context, productId string) (Product, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/product/{productId}"
...
/*
ProductsApiService Update
Update a product
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param productId The id of the product to retrieve
@return Product
*/
func (a *ProductsApiService) UpdateProduct(ctx context.Context, productId string) (Product, *http.Response, error) {
	var (
